...
class PredicatePushDown (
  ...
  def isSingleColumn(predicate: Expression) =
...
class FilterPushDown (
  ...
  def isSingleColumn(filter: Filter) =
    filter.isInstanceOf[sources.In] || filter.isInstanceOf[sources.EqualTo] ||
...
class RddPredicateSelectPdTrf(
                                  attributes: Seq[Attribute],
                                  columnNameByLowercase: Map[String, String],
...
class RddFilterSelectPdTrf(requiredColumns: Array[String],
                           columnNameByLowercase: Map[String, String],
